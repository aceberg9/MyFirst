...
export const follow = (userId) => ({type: FOLLOW, userId}) // === {return{type: ADD_POST}} // AC=ActionCreator
...
export const toggleIsFollowingProgress = (isFetching, userId) => ({type: TOGGLE_SI_FOLLOWING_PROGRESS, isFetching, userId})
